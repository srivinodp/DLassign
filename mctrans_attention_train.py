...
Original file is located at
    https://colab.research.google.com/drive/1I1xJQvWPzZ01ibqd0IHHQ6jsKcJUE9Fn
"""
...
def train_step(inp, targ, enc_hidden):
  ...
  with tf.GradientTape() as tape:
    ...
    for t in range(1, targ.shape[1]):
      predictions, dec_hidden, dec_cell = decoder(dec_input,[dec_hidden,dec_cell],enc_output)
...
#   attention_plot = np.zeros((max_length_targ, max_length_inp))
  ...
  for t in range(max_length_targ):
    predictions, dec_hidden, dec_cell = decoder(dec_input,
                                                         [dec_hidden,dec_cell],
                                                         enc_out)
...
encoder.save_weights('/content/drive/My Drive/encoder_last_attention.h5')
decoder.save_weights('/content/drive/My Drive/decoder_last_attention.h5')
